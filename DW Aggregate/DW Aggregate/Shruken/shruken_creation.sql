CREATE DATABASE  IF NOT EXISTS `dw-2205-team4_shrunkendimension` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `dw-2205-team4_shrunkendimension`;
-- MySQL dump 10.13  Distrib 8.0.23, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: dw-2205-team4_shrunkendimension
-- ------------------------------------------------------
...
--
-- Table structure for table `sale_quarter_dim`
--

DROP TABLE IF EXISTS `sale_quarter_dim`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `sale_quarter_dim` (
  ...
  `Sales_Quarter_SK` int NOT NULL,
  PRIMARY KEY (`Sales_Quarter_SK`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `sales_fact_shrunken`
--

DROP TABLE IF EXISTS `sales_fact_shrunken`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `sales_fact_shrunken` (
  `Customer_SK` int NOT NULL,
  `Product_SK` int NOT NULL,
  `Sales_Quarter_SK` int NOT NULL,
  ...
  PRIMARY KEY (`Customer_SK`,`Product_SK`,`Sales_Quarter_SK`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping events for database 'dw-2205-team4_shrunkendimension'
--
...
-- Dump completed on 2021-05-08 21:43:50
